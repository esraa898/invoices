...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('status_update',[$invoice->id]) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                      ...
                      @csrf
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number" value="{{$invoice->invoice_number}}"
                                    ...
                                    <input type="hidden" name="detail_id" value="{{$invoice->invoicedetails->id}}">
                            </div>

                            <div class="col">
                                <label>تاريخ الفاتورة</label>
                                <input class="form-control fc-datepicker" name="invoice_date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ date('Y-m-d') }}" required value="{{$invoice->invoice_date}}" readonly>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_commission"value="{{$invoice->Amount_commission}}" readonly
